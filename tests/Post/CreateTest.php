...
final class CreateTest extends JsonApiTestCase
{
    ...
    public function testCreatePostSuccess(): void
    {
        ...
        $this->assertResponse($response, 'Post/create_success', Response::HTTP_CREATED);
    }

    public function testCreatePostMissingAllData(): void
    {
        $this->client->request(
            method: 'POST',
            uri: '/api/posts',
    ...
    public function testCreatePostTooLongDescription(): void
    {
        $this->client->request(
            method: 'POST',
            uri: '/api/posts',
